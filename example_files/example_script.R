...
experimental_sample_prefixes <- c(paste0(mode_prefix, ".th")) # List experimental sample names. '.' are read as hyphens in .tsv files
...
# Read the TSV file
file_path <- "C:/Users/User/Desktop/example_files/Report_RTseparated.tsv"
...
saveWorkbook(wb, paste0(mode_prefix, "_MetaboKit_filtered_TH_output.xlsx"), overwrite = TRUE)